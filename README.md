...
1.21.8 [Purpur](https://github.com/PurpurMC/Purpur) fork that brings vertical scaling to Minecraft.
...
dependencies {
  compile "com.github.puregero:shreddedpaper-api:1.21.8-R0.1-SNAPSHOT"
}
```
